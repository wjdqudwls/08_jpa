...
import com.wjdqudwls.springdatajpa.common.Pagination;
import com.wjdqudwls.springdatajpa.common.PagingButton;
...
public class MenuController {
  ...
  public String findMenuList(Model model, @PageableDefault Pageable pageable) {
    ...
    // 로그 레벨 5가지
    // trace < debug < info < warning < fatal(사용 불가)
  ...
  @GetMapping("/category")
  @ResponseBody // 응답 데이터를 바디에 담아서 그대로 전달하겠다는 의미로써
                // View Resolver 사용 X
