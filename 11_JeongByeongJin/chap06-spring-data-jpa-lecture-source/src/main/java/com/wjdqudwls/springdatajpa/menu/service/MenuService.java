...
import com.wjdqudwls.springdatajpa.menu.dto.CategoryDTO;
import com.wjdqudwls.springdatajpa.menu.dto.MenuDTO;
import com.wjdqudwls.springdatajpa.menu.entity.Category;
import com.wjdqudwls.springdatajpa.menu.entity.Menu;
import com.wjdqudwls.springdatajpa.menu.repository.CategoryRepository;
...
//            menuPrice, Sort.by("menuPrice").descending());
  ...
  public void registMenu(MenuDTO menuDTO) {
    ...
    // 내부적으로 Menu 엔티티를 엔티티 메니저가 persist()
  ...
  public void modifyMenu(MenuDTO menuDTO){
    ...
    Menu foundMenu = menuRepository.findById(menuDTO.getMenuCode())
                    .orElseThrow(IllegalArgumentException::new);
    // 2) 영속 상태 엔티티의 필드 수정
    // setter 사용 (지양) 이름 수정 메서드를 정의하여 사용
